 ...
 * @author stan
 */
public class WatchStartingFolder2 implements Runnable
    {
    WatchFileEventsSw2 watchFileEventsSw2 = null;
    JFileFinderWin jFileFinderWin = null;
    Object lockObj = new Object();
    BlockingQueue<Integer> allowToRunQueue = new LinkedBlockingQueue<>(100);
    boolean runFlag = true;
    
    public WatchStartingFolder2( JFileFinderWin jFileFinderWin ) //, Object lockObj )
        {
...
//            jFileFinderWin.callSearchBtnActionPerformed( null );
    ...
    public void restart()
        ...
        try {
            ...
            Logger.getLogger(WatchStartingFolder2.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public void run()
        ...
        watchFileEventsSw2 = new WatchFileEventsSw2( "watchStartFolder2", Paths.get( jFileFinderWin.getStartingFolder() ), 750, fileEventQueue );
        ...
        while ( runFlag )
            ...
            try {
                ...
                watchFileEventsSw2.restart( Paths.get( jFileFinderWin.getStartingFolder() ) );
                //watchFileEventsSw2.setQueueDeletesFlag(true);
