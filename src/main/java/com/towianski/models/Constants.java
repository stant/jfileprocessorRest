...
public class Constants
    ...
    public static final String PATH_PROTOCOL_HTTPS = "https://";
    ...
    public static final int COPY_PROTOCOL_HTTPS_GET = 3;
    public static final int COPY_PROTOCOL_HTTPS_PUT = 4;
