 ...
 */
public class HttpsReturnFileFrame extends javax.swing.JFrame {

    private static final MyLogger logger = MyLogger.getLogger(HttpsReturnFileFrame.class.getName() );
     ...
     */
    public HttpsReturnFileFrame( ConnUserInfo connUserInfo, String locFile, String user, String password, String rhost, String rmtFile )
        {
        initComponents();
