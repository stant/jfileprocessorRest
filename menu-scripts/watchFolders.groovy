...
class WatchFolders1Impl {
    ...
    def outFile = new File( System.getProperty("java.io.tmpdir") + System.getProperty( "file.separator") + "watchFolders1-" + pathList.get(0).toString().replace( System.getProperty( "file.separator"), "-") + ".log" );
    outFile.write "";
    ...
    while ( runFlag ) 
        ...
        try {
            ...
            System.out.println("watchFolders1 waiting to get runallow token" );
...
public void restart()
 ...
 static void main(String[] args) {
    System.out.println( "entered watchFolders1.groovy.main()");
...
//    ResultsData resultsData = binding.getVariable( "resultsData" );
    ...
    WatchFolders1Impl watchFolders1Impl = new WatchFolders1Impl();
    watchFolders1Impl.codeProcessorPanel = binding.getVariable( "codeProcessorPanel" );
    System.out.println( "got codeProcessorPanel.jFileFinderWin.getStartingFolder() =" + codeProcessorPanel.jFileFinderWin.getStartingFolder() + "=" );
    watchFolders1Impl.defaultComboBoxModel = binding.getVariable( "defaultComboBoxModel" );
    watchFolders1Impl.resultsData = binding.getVariable( "resultsData" );

    watchFolders1Impl.run();
 }
