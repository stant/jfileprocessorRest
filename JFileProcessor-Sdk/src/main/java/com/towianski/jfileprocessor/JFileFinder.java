...
//    private JFileFinderWin jFileFinderWin = null;
    ...
    private JFileFinderSwingWorker jFileFinderSwingWorker = null;
    private ResultsData resultsData = null;

    public JFileFinder( int filesysTypeArg, String startingPathArg, String patternTypeArg, String filePatternArg, FilterChain chainFilterList, FilterChain chainFilterFolderList, FilterChain chainFilterPreVisitFolderList )
    {
        this.filesysType = filesysTypeArg;
...
//        filePattern = args[1];
        ...
        JFileFinder jfilefinder = new JFileFinder( Constants.FILESYSTEM_POSIX, args[0], args[1], args[2], null, null, null );
