...
//                    scpTo.copyTo( file.toString(), "kids", "hostess", "localhost", DesktopUtils.getUserTmp() + System.getProperty( "file.separator") + file.getName().toString() );
                    String tmp = "/net2/github/JFileProcessor-Server/build/libs/JFileProcessor-Server-1.5.11.jar";
                    jschSftpUtils.copyIfMissing( tmp, "stan", "yearly55", "192.168.56.103", "/opt/jFileProcessor/JFileProcessor-Server-1.5.11.jar" );
