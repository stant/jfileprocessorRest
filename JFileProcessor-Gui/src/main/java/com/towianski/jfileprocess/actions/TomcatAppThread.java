            ...
            try
                ...
                if ( response == null || ! response.equalsIgnoreCase( "RUNNING" ) )
                    ...
                    if ( ++downTimes > 5 )
                        ...
                        jfpFilename = jfpFilename.replace( "-Gui", "-Server" );
                        scpTo.copyIfMissing( System.getProperty( "user.dir" ) + System.getProperty( "file.separator" ) + jfpFilename, user, passwd, rmtHost, jfpFilename );
                        System.out.println( "try scpTo   file =" + System.getProperty( "user.dir" ) + System.getProperty( "file.separator" ) + jfpFilename + "=   to remote =" + user + "@" + rmtHost + ":" + jfpFilename + "=" );
